...
export ADVSEC_SATELO_ENABLED_PATH=/tmp/advsec_satelo_enabled
...
export ADVSEC_SATE_RFC_ENABLED=`syscfg get Adv_AdvSecSATERFCEnable`
export ADVSEC_SATELO_RFC_ENABLED=`syscfg get Adv_AdvSecSATELORFCEnable`
...
export ADV_SATE_RFC_ENABLE_LOG=ADVANCE_SECURITY_SATE_ENABLED
export ADV_SATE_RFC_DISABLE_LOG=ADVANCE_SECURITY_SATE_DISABLED
export ADV_SATELO_RFC_ENABLE_LOG=ADVANCE_SECURITY_SATELO_ENABLED
export ADV_SATELO_RFC_DISABLE_LOG=ADVANCE_SECURITY_SATELO_DISABLED
