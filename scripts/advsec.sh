...
export ADVSEC_CPE_PROTECTION_NETWORK_ENABLED_PATH=/tmp/advsec_cpe_protection_network_enabled
...
export ADVSEC_CPE_PROTECTION_NETWORK_RFC_ENABLED=`syscfg get Adv_CPEProtectionNetworkRFCEnable`
...
export ADV_CPE_PROTECTION_NETWORK_RFC_ENABLE_LOG=ADVANCE_SECURITY_CPE_PROTECTION_NETWORK_ENABLED
export ADV_CPE_PROTECTION_NETWORK_RFC_DISABLE_LOG=ADVANCE_SECURITY_CPE_PROTECTION_NETWORK_DISABLED
