...
export ADVSEC_LEVLMLO_ENABLED_PATH=/tmp/advsec_levlmlo_enabled
export ADVSEC_DEVICEFINGERPRINTLASTSEEN_ENABLED_PATH=/tmp/advsec_devicefingerprintlastseen_enabled
export ADVSEC_DFDNSSAFESEARCH_ENABLED_PATH=/tmp/advsec_dfdnssafesearch_enabled
export ADVSEC_DEVICEFINGERPRINTLOCALHTTPUA_ENABLED_PATH=/tmp/advsec_devicefingerprintlocalhttpua_enabled
export ADVSEC_CPEPROTECTIONNETWORK_ENABLED_PATH=/tmp/advsec_cpeprotectionnetwork_enabled
...
export ADVSEC_LEVLMLO_RFC_ENABLED=$(syscfg get Adv_LevlMLORFCEnable)
export ADVSEC_DEVICEFINGERPRINTLASTSEEN_RFC_ENABLED=$(syscfg get Adv_DFLastSeenRFCEnable)
export ADVSEC_DFDNSSAFESEARCH_RFC_ENABLED=$(syscfg get Adv_DFDNSSafeSearchRFCEnable)
export ADVSEC_DEVICEFINGERPRINTLOCALHTTPUA_RFC_ENABLED=$(syscfg get Adv_DFLocalHTTPUARFCEnable)
export ADVSEC_CPEPROTECTIONNETWORK_RFC_ENABLED=$(syscfg get Adv_CpeProtectionNetworkRFCEnable)
...
export ADV_LEVLMLO_RFC_ENABLE_LOG=ADVANCE_SECURITY_LEVLMLO_ENABLED
export ADV_LEVLMLO_RFC_DISABLE_LOG=ADVANCE_SECURITY_LEVLMLO_DISABLED
export ADV_DEVICEFINGERPRINTLASTSEEN_RFC_ENABLE_LOG=ADVANCE_SECURITY_DEVICEFINGERPRINTLASTSEEN_ENABLED
export ADV_DEVICEFINGERPRINTLASTSEEN_RFC_DISABLE_LOG=ADVANCE_SECURITY_DEVICEFINGERPRINTLASTSEEN_DISABLED
export ADV_DFDNSSAFESEARCH_RFC_ENABLE_LOG=ADVANCE_SECURITY_DFDNSSAFESEARCH_ENABLED
export ADV_DFDNSSAFESEARCH_RFC_DISABLE_LOG=ADVANCE_SECURITY_DFDNSSAFESEARCH_DISABLED
export ADV_DEVICEFINGERPRINTLOCALHTTPUA_RFC_ENABLE_LOG=ADVANCE_SECURITY_DEVICEFINGERPRINTLOCALHTTPUA_ENABLED
export ADV_DEVICEFINGERPRINTLOCALHTTPUA_RFC_DISABLE_LOG=ADVANCE_SECURITY_DEVICEFINGERPRINTLOCALHTTPUA_DISABLED
export ADV_CPEPROTECTIONNETWORK_RFC_ENABLE_LOG=ADVANCE_SECURITY_CPEPROTECTIONNETWORK_ENABLED
export ADV_CPEPROTECTIONNETWORK_RFC_DISABLE_LOG=ADVANCE_SECURITY_CPEPROTECTIONNETWORK_DISABLED
