...
export ADVSEC_DFMLO_ENABLED_PATH=/tmp/advsec_dfmlo_enabled
...
export ADVSEC_DFMLO_RFC_ENABLED=$(syscfg get Adv_DFMLORFCEnable)
...
export ADV_DFMLO_RFC_ENABLE_LOG=ADVANCE_SECURITY_DFMLO_ENABLED
export ADV_DFMLO_RFC_DISABLE_LOG=ADVANCE_SECURITY_DFMLO_DISABLED
