...
typedef  struct
_COSA_DATAMODEL_LEVLMLO_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_LEVLMLO_RFC,  *PCOSA_DATAMODEL_LEVLMLO_RFC;

typedef  struct
_COSA_DATAMODEL_DEVICEFINGERPRINTLASTSEEN_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_DEVICEFINGERPRINTLASTSEEN_RFC,  *PCOSA_DATAMODEL_DEVICEFINGERPRINTLASTSEEN_RFC;

typedef  struct
_COSA_DATAMODEL_ADVSECDEVICEFINGERPRINTDNSSAFESEARCH_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_ADVSECDEVICEFINGERPRINTDNSSAFESEARCH_RFC,  *PCOSA_DATAMODEL_ADVSECDEVICEFINGERPRINTDNSSAFESEARCH_RFC;

typedef  struct
_COSA_DATAMODEL_DEVICEFINGERPRINTLOCALHTTPUA_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_DEVICEFINGERPRINTLOCALHTTPUA_RFC,  *PCOSA_DATAMODEL_DEVICEFINGERPRINTLOCALHTTPUA_RFC;

typedef  struct
_COSA_DATAMODEL_CPEPROTECTIONNETWORK_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_CPEPROTECTIONNETWORK_RFC,  *PCOSA_DATAMODEL_CPEPROTECTIONNETWORK_RFC;
...
_COSA_DATAMODEL_AGENT
{
    ...
    PCOSA_DATAMODEL_LEVLMLO_RFC pLevlMLO_RFC;
    PCOSA_DATAMODEL_DEVICEFINGERPRINTLASTSEEN_RFC pDFLastSeen_RFC;
    PCOSA_DATAMODEL_ADVSECDEVICEFINGERPRINTDNSSAFESEARCH_RFC pDFDNSSafeSearch_RFC;
    PCOSA_DATAMODEL_DEVICEFINGERPRINTLOCALHTTPUA_RFC pDFLocalHTTPUA_RFC;
    PCOSA_DATAMODEL_CPEPROTECTIONNETWORK_RFC pCpeProtectionNetwork_RFC;
...
ANSC_STATUS
CosaAdvSecLevlMLOInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecLevlMLODeInit
    (
        ANSC_HANDLE hThisObject
    );
...
ANSC_STATUS
CosaAdvSecDFLastSeenDeInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecDFDNSSafeSearchInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecDFDNSSafeSearchDeInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecDFLocalHTTPUAInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecDFLocalHTTPUADeInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaCpeProtectionNetworkInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaCpeProtectionNetworkDeInit
    (
        ANSC_HANDLE hThisObject
    );
