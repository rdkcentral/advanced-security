...
typedef struct
_COSA_DATAMODEL_NETWORKINTELLIGENCE {
    BOOL            bActivate;
}
COSA_DATAMODEL_NETWORKINTELLIGENCE,  *PCOSA_DATAMODEL_NETWORKINTELLIGENCE;
...
_COSA_DATAMODEL_AGENT
{
    ...
    PCOSA_DATAMODEL_NETWORKINTELLIGENCE pNetworkIntelligence;
...
ANSC_STATUS
CosaNetworkIntelligenceActivate
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaNetworkIntelligenceDeactivate
    (
        ANSC_HANDLE hThisObject
    );
