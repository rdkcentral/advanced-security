...
typedef  struct
_COSA_DATAMODEL_ADVSECSATELO_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_ADVSECSATELO_RFC,  *PCOSA_DATAMODEL_ADVSECSATELO_RFC;
...
_COSA_DATAMODEL_AGENT
{
    ...
    PCOSA_DATAMODEL_ADVSECSATELO_RFC pAdvSecSATELO_RFC;
...
ANSC_STATUS
CosaAdvSecSATELOInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecSATELODeInit
    (
        ANSC_HANDLE hThisObject
    );
