...
typedef  struct
_COSA_DATAMODEL_ADVSECCPEPROTECTIONNETWORK_RFC {
    BOOL            bEnable;
}
COSA_DATAMODEL_ADVSECCPEPROTECTIONNETWORK_RFC,  *PCOSA_DATAMODEL_ADVSECCPEPROTECTIONNETWORK_RFC;
...
_COSA_DATAMODEL_AGENT
{
    ...
    PCOSA_DATAMODEL_ADVSECCPEPROTECTIONNETWORK_RFC pAdvSecCPEProtectionNetwork_RFC;
...
ANSC_STATUS
CosaAdvSecCPEProtectionNetworkInit
    (
        ANSC_HANDLE hThisObject
    );

ANSC_STATUS
CosaAdvSecCPEProtectionNetworkDeInit
    (
        ANSC_HANDLE hThisObject
    );
